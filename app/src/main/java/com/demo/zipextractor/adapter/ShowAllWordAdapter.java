...
public class ShowAllWordAdapter extends RecyclerView.Adapter<ShowAllWordAdapter.ViewHolder> implements Filterable {
    ...
    public ShowAllWordAdapter(Context context, ArrayList<FileListModel> arrayList, ArrayList<FileListModel> arrayList2, RecyclerItemClick recyclerItemClick, CheakBoxClick cheakBoxClick) {
        ...
        return new Filter() {
            ...
            protected Filter.FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (trim.length() > 0) {
                    ...
                    Iterator<FileListModel> it = ShowAllWordAdapter.this.list.iterator();
                    while (it.hasNext()) {
                    ...
                    filterResults.values = ShowAllWordAdapter.this.list;
                    filterResults.count = ShowAllWordAdapter.this.list.size();
                }
            ...
            protected void publishResults(CharSequence charSequence, Filter.FilterResults filterResults) {
                ShowAllWordAdapter.this.filterList = (ArrayList) filterResults.values;
                ShowAllWordAdapter.this.notifyDataSetChanged();
            }
        };
    }
        ...
        public ViewHolder(View view) {
            ...
            itemShowAllFilesBinding.llMain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view2) {
                    ShowAllWordAdapter.this.itemClick.onRecyclerClick(ViewHolder.this.getAdapterPosition());
                }
            });
            this.binding.llCheckBox.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view2) {
                    if (((DocumentActivity) ShowAllWordAdapter.this.mContext).selectedList.contains(ShowAllWordAdapter.this.filterList.get(ViewHolder.this.getAdapterPosition()))) {
                        ((DocumentActivity) ShowAllWordAdapter.this.mContext).selectedList.remove(ShowAllWordAdapter.this.filterList.get(ViewHolder.this.getAdapterPosition()));
                        ViewHolder.this.binding.checkBox.setChecked(false);
                        ViewHolder.this.binding.llMain.setBackgroundColor(ContextCompat.getColor(ShowAllWordAdapter.this.mContext, R.color.main_bg));
                    } else {
                        ((DocumentActivity) ShowAllWordAdapter.this.mContext).selectedList.add(ShowAllWordAdapter.this.filterList.get(ViewHolder.this.getAdapterPosition()));
                        ViewHolder.this.binding.checkBox.setChecked(true);
                        ViewHolder.this.binding.llMain.setBackgroundColor(ContextCompat.getColor(ShowAllWordAdapter.this.mContext, R.color.selected_card));
                    }
                    ShowAllWordAdapter.this.cheakBoxClick.onCheakBoxClick(ViewHolder.this.getAdapterPosition(), ShowAllWordAdapter.this.list);
                }
            });
        }
    }
