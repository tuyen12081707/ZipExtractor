...
public class ShowAllExcelAdapter extends RecyclerView.Adapter<ShowAllExcelAdapter.ViewHolder> implements Filterable {
    ...
    public ShowAllExcelAdapter(Context context, ArrayList<FileListModel> arrayList, ArrayList<FileListModel> arrayList2, RecyclerItemClick recyclerItemClick, CheakBoxClick cheakBoxClick) {
        ...
        return new Filter() {
            ...
            protected Filter.FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (trim.length() > 0) {
                    ...
                    Iterator<FileListModel> it = ShowAllExcelAdapter.this.list.iterator();
                    while (it.hasNext()) {
                    ...
                    filterResults.values = ShowAllExcelAdapter.this.list;
                    filterResults.count = ShowAllExcelAdapter.this.list.size();
                }
            ...
            protected void publishResults(CharSequence charSequence, Filter.FilterResults filterResults) {
                ShowAllExcelAdapter.this.filterList = (ArrayList) filterResults.values;
                ShowAllExcelAdapter.this.notifyDataSetChanged();
            }
        };
    }
        ...
        public ViewHolder(View view) {
            ...
            itemShowAllFilesBinding.llMain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view2) {
                    ShowAllExcelAdapter.this.itemClick.onRecyclerClick(ViewHolder.this.getAdapterPosition());
                }
            });
            this.binding.llCheckBox.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view2) {
                    if (((DocumentActivity) ShowAllExcelAdapter.this.mContext).selectedList.contains(ShowAllExcelAdapter.this.filterList.get(ViewHolder.this.getAdapterPosition()))) {
                        ((DocumentActivity) ShowAllExcelAdapter.this.mContext).selectedList.remove(ShowAllExcelAdapter.this.filterList.get(ViewHolder.this.getAdapterPosition()));
                        ViewHolder.this.binding.checkBox.setChecked(false);
                        ViewHolder.this.binding.llMain.setBackgroundColor(ContextCompat.getColor(ShowAllExcelAdapter.this.mContext, R.color.main_bg));
                    } else {
                        ((DocumentActivity) ShowAllExcelAdapter.this.mContext).selectedList.add(ShowAllExcelAdapter.this.filterList.get(ViewHolder.this.getAdapterPosition()));
                        ViewHolder.this.binding.checkBox.setChecked(true);
                        ViewHolder.this.binding.llMain.setBackgroundColor(ContextCompat.getColor(ShowAllExcelAdapter.this.mContext, R.color.selected_card));
                    }
                    ShowAllExcelAdapter.this.cheakBoxClick.onCheakBoxClick(ViewHolder.this.getAdapterPosition(), ShowAllExcelAdapter.this.list);
                }
            });
        }
    }
