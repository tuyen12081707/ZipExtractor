...
public class ShowAllPPTAdapter extends RecyclerView.Adapter<ShowAllPPTAdapter.ViewHolder> implements Filterable {
    ...
    public ShowAllPPTAdapter(Context context, ArrayList<FileListModel> arrayList, ArrayList<FileListModel> arrayList2, RecyclerItemClick recyclerItemClick, CheakBoxClick cheakBoxClick) {
        ...
        return new Filter() {
            ...
            protected Filter.FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (trim.length() > 0) {
                    ...
                    Iterator<FileListModel> it = ShowAllPPTAdapter.this.list.iterator();
                    while (it.hasNext()) {
                    ...
                    filterResults.values = ShowAllPPTAdapter.this.list;
                    filterResults.count = ShowAllPPTAdapter.this.list.size();
                }
            ...
            protected void publishResults(CharSequence charSequence, Filter.FilterResults filterResults) {
                ShowAllPPTAdapter.this.filterList = (ArrayList) filterResults.values;
                ShowAllPPTAdapter.this.notifyDataSetChanged();
            }
        };
    }
        ...
        public ViewHolder(View view) {
            ...
            itemShowAllFilesBinding.llMain.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view2) {
                    ShowAllPPTAdapter.this.itemClick.onRecyclerClick(ViewHolder.this.getAdapterPosition());
                }
            });
            this.binding.llCheckBox.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view2) {
                    if (((DocumentActivity) ShowAllPPTAdapter.this.mContext).selectedList.contains(ShowAllPPTAdapter.this.filterList.get(ViewHolder.this.getAdapterPosition()))) {
                        ((DocumentActivity) ShowAllPPTAdapter.this.mContext).selectedList.remove(ShowAllPPTAdapter.this.filterList.get(ViewHolder.this.getAdapterPosition()));
                        ViewHolder.this.binding.checkBox.setChecked(false);
                        ViewHolder.this.binding.llMain.setBackgroundColor(ContextCompat.getColor(ShowAllPPTAdapter.this.mContext, R.color.main_bg));
                    } else {
                        ((DocumentActivity) ShowAllPPTAdapter.this.mContext).selectedList.add(ShowAllPPTAdapter.this.filterList.get(ViewHolder.this.getAdapterPosition()));
                        ViewHolder.this.binding.checkBox.setChecked(true);
                        ViewHolder.this.binding.llMain.setBackgroundColor(ContextCompat.getColor(ShowAllPPTAdapter.this.mContext, R.color.selected_card));
                    }
                    ShowAllPPTAdapter.this.cheakBoxClick.onCheakBoxClick(ViewHolder.this.getAdapterPosition(), ShowAllPPTAdapter.this.list);
                }
            });
        }
    }
