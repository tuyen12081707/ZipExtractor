...
import com.demo.zipextractor.databinding.FragmentExcelFilesBinding;
...
public class ExcelFilesFragment extends Fragment implements RecyclerItemClick, CheakBoxClick, View.OnClickListener {
    String ROOT_PATH;
    public AllDocsAdapter adapter;
    FragmentExcelFilesBinding binding;
    ...
    public ExcelFilesFragment(Activity activity) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.binding = (FragmentExcelFilesBinding) DataBindingUtil.inflate(layoutInflater, R.layout.fragment_excel_files, viewGroup, false);
        initView();
        initClick();
        setData();
    ...
    public void setAdapter() {
        ...
        try {
            ...
            this.adapter = new AllDocsAdapter(activity, ((DocumentActivity) activity).listExcel, ((DocumentActivity) activity).selectedList, this, (CheakBoxClick) getActivity());
    ...
    public void setExcelData() {
        this.adapter.setList(((DocumentActivity) getActivity()).listExcel);
    }
    ...
    private void openCompressDialog() {
        ...
        if (((DocumentActivity) getActivity()).selectedList.size() > 1) {
            ...
            this.nameFile = FilenameUtils.getBaseName(((DocumentActivity) getActivity()).listExcel.get(this.itemPos).getFilename());
    ...
    private void showConfirmationDeleteDialog() {
        ...
        dialogDeleteBinding.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                for (int i = 0; i < ((DocumentActivity) ExcelFilesFragment.this.getActivity()).selectedList.size(); i++) {
                    File file = new File(((DocumentActivity) ExcelFilesFragment.this.getActivity()).selectedList.get(i).getFilePath());
                    AppConstants.cleaner(file);
                    ExcelFilesFragment.this.adapter.removeItem(i);
                    ExcelFilesFragment.this.adapter.getList().removeAll(((DocumentActivity) ExcelFilesFragment.this.getActivity()).selectedList);
                    ExcelFilesFragment.this.refreshList();
                    AppConstants.refreshGallery(file.getAbsolutePath(), ExcelFilesFragment.this.getActivity());
                }
                ExcelFilesFragment.this.adapter.notifyDataSetChanged();
                ExcelFilesFragment.this.checkListSize();
            }
        });
    ...
    private void renameDialog() {
        ...
        this.dialogRenameBinding.edRenameFileName.setText(FilenameUtils.getBaseName(((DocumentActivity) getActivity()).listExcel.get(this.itemPos).getFilePath()));
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnOk:
                ...
                this.ROOT_PATH = ((DocumentActivity) getActivity()).listExcel.get(this.itemPos).getFilePath();
                ...
                ((DocumentActivity) getActivity()).listExcel.set(this.itemPos, fileListModel);
                refreshList();
            ...
            case R.id.buttonnCompress:
                ...
                this.disposable.add((Disposable) Observable.fromCallable(new Callable() {
                    ...
                    public final Object call() {
                        return ExcelFilesFragment.this.m128x3465afd1();
                    }
                    ...
                    public void onComplete() {
                        ExcelFilesFragment.this.binding.rlProgess.setVisibility(View.GONE);
                        Toast.makeText(ExcelFilesFragment.this.getActivity(), "Zip File Successfully", Toast.LENGTH_SHORT).show();
                        ExcelFilesFragment.this.refreshList();
                    }
                }));
                return;
            ...
            case R.id.layoutInfo:
                ...
                bottomsheetInfoBinding.txtFilePath.setText(((DocumentActivity) getActivity()).listExcel.get(this.itemPos).getFilePath());
                bottomsheetInfoBinding.txtFileSize.setText(AppConstants.convertStorage(((DocumentActivity) getActivity()).listExcel.get(this.itemPos).getFileSize()));
                bottomsheetInfoBinding.txtTime.setText(new SimpleDateFormat("dd/MM/yyyy").format(new Date(((DocumentActivity) getActivity()).listExcel.get(this.itemPos).getFileDate())));
    ...
    public void checkListSize() {
        try {
            ...
            e.printStackTrace();
            Log.e("MYTAG", "ErrorNo: checkListSize excle:" +e);
        }
    }
}
