...
import com.demo.zipextractor.databinding.FragmentTXTFileBinding;
...
public class TXTFileFragment extends Fragment implements RecyclerItemClick, CheakBoxClick, View.OnClickListener {
    ...
    public TXTFileFragment(Activity activity) {
    ...
    public void setAdapter() {
        ...
        try {
            ...
            Log.e("MYTAG", "ErrorNo: listAll:" + ((DocumentActivity) activity).listTxt);
            ...
            case R.id.buttonnCompress:
                ...
                this.disposable.add((Disposable) Observable.fromCallable(new Callable() {
                    ...
                    public final Object call() {
                        return TXTFileFragment.this.m131x46be36bb();
                    }
                    ...
                    public void onComplete() {
                        TXTFileFragment.this.binding.rlProgess.setVisibility(View.GONE);
                        Toast.makeText(TXTFileFragment.this.getActivity(), "Zip File Successfully", Toast.LENGTH_SHORT).show();
                        TXTFileFragment.this.refreshList();
                    }
                }));
                return;
    ...
    public void checkListSize() {
        try {
            ...
            e.printStackTrace();
            Log.e("MYTAG", "ErrorNo: checkListSize txt:" +e);
        }
    }
}
