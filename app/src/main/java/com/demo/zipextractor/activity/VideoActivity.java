...
import com.demo.zipextractor.databinding.ActivityVideoBinding;
...
public class VideoActivity extends BaseActivity implements RecyclerItemClick, CheakBoxClick, View.OnClickListener {
    ...
    static int access$212(VideoActivity videoActivity, int i) {
        int i2 = videoActivity.progressStatus + i;
        videoActivity.progressStatus = i2;
        return i2;
    }
    ...
    public void setBinding() {
        ...
        setSupportActionBar(this.binding.toolBarVideo.toolBar);

    }

    @Override
    public void setToolBar() {
        this.binding.toolBarVideo.title.setText(R.string.video_title);
        this.binding.toolBarVideo.cardBack.setOnClickListener(this);
    }
    ...
    private void initClick() {
        this.binding.toolBarVideo.cardSort.setOnClickListener(this);
        this.binding.toolBarVideo.cardCopy.setOnClickListener(this);
    ...
    private void fillData() {
        ...
        new DocumentFetcher(this, FileRoot.VIDEO, FileRoot.VIDEO, "", DocumentFetcher.ORDER_AZ, new DocumentFetcher.OnFileFetchListnear() {
            @Override
            public final void onFileFetched(List list) {
                VideoActivity.this.mainList.addAll(list);
                VideoActivity.this.setAdapter();
                AppConstants.sortDateDesc(VideoActivity.this.mainList);
                VideoActivity.this.cheakEmptyData();
            }
        });
        this.binding.rlProgess.setVisibility(View.GONE);
        this.binding.toolBarVideo.cardSort.setVisibility(View.VISIBLE);
    }
    ...
    public void onRecyclerClick(int i) {
        this.isClicked = true;
        this.itemPos = i;
        AppConstants.openWith(this, Uri.fromFile(new File(this.adapter.getList().get(i).getFilePath())), "video/*");
    }
    ...
    private void showProgressDialogWithTitle(String str, String str2) {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                while (VideoActivity.this.progressStatus < 100) {
                    try {
                        Thread.sleep(200L);
                        VideoActivity.access$212(VideoActivity.this, 5);
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                    }
                    VideoActivity.this.handler.post(new Runnable() {
                        @Override
                        public void run() {
                            VideoActivity.this.progressDialog.setProgress(VideoActivity.this.progressStatus);
                        }
                    });
                }
                VideoActivity.this.hideProgressDialogWithTitle();
            }
        }).start();
    }
    ...
    public void onCheakBoxClick(int i, ArrayList<FileListModel> arrayList) {
        ...
        if (arrayList.size() > 0) {
            ...
            this.binding.toolBarVideo.cardSort.setVisibility(View.GONE);
            this.binding.toolBarVideo.cardCopy.setVisibility(View.VISIBLE);
            this.binding.tvItem.setText(arrayList.size() + " items");
        } else {
            this.binding.llOption.setVisibility(View.GONE);
            this.binding.toolBarVideo.cardSort.setVisibility(View.VISIBLE);
            this.binding.toolBarVideo.cardCopy.setVisibility(View.GONE);
        }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.buttonnCompress:
                ...
                showProgressDialogWithTitle("Compress", "Loading...");
                this.dialogCompress.dismiss();
                this.disposable.add((Disposable) Observable.fromCallable(new Callable() {
                    @Override
                    public final Object call() {
                        return VideoActivity.this.m125xc646a5c3();
                    }
                    ...
                    public void onComplete() {
                        if (!VideoActivity.this.nameFile.isEmpty()) {
                            VideoActivity.this.binding.rlProgess.setVisibility(View.GONE);
                        }
                        VideoActivity.this.refreshList();
                        Toast.makeText(VideoActivity.this, "Zip File Successfully", Toast.LENGTH_SHORT).show();
                    }
                }));
                return;
            case R.id.cardBack:
            ...
            case R.id.cardCopy:
                if (this.adapter.isSelectAll) {
                    this.selectedFileList.clear();
                    this.binding.toolBarVideo.ivSelectAll.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_select_none));
                    this.adapter.unselectall();
                } else {
                    this.selectedFileList.clear();
                    this.selectedFileList.addAll(this.mainList);
                    this.binding.toolBarVideo.ivSelectAll.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_select_all));
            ...
            case R.id.layoutCopy:
                ...
                this.activityLauncher.launch(intent, new BetterActivityResult.OnActivityResult() {
                    ...
                    public final void onActivityResult(Object obj) {
                        VideoActivity.this.m123xe2f35985((ActivityResult) obj);
                    }
                });
            ...
            case R.id.layoutExtract:
                this.activityLauncher.launch(new Intent(this, SaveLocationActivity.class), new BetterActivityResult.OnActivityResult() {
                    ...
                    public final void onActivityResult(Object obj) {
                        VideoActivity.this.m120xdf66728((ActivityResult) obj);
                    }
                });
                this.dialogMultiBottomSheet.dismiss();
                return;
            ...
            case R.id.layoutMove:
                ...
                this.activityLauncher.launch(intent2, new BetterActivityResult.OnActivityResult() {
                    ...
                    public final void onActivityResult(Object obj) {
                        VideoActivity.this.m124xd49cffa4((ActivityResult) obj);
                    }
                });
                this.dialogMultiBottomSheet.dismiss();
                return;
            ...
            case R.id.ll:
                ...
                this.activityLauncher.launch(intent4, new BetterActivityResult.OnActivityResult() {
                    ...
                    public final void onActivityResult(Object obj) {
                        VideoActivity.this.m126xb7f04be2((ActivityResult) obj);
                    }
                });
                return;
            case R.id.llCompress:
                ...
                this.activityLauncher.launch(intent5, new BetterActivityResult.OnActivityResult() {
                    ...
                    public final void onActivityResult(Object obj) {
                        VideoActivity.this.m121xffa00d47((ActivityResult) obj);
                    }
                });
                return;
            case R.id.llDateAsc:
    ...
    public void m120xdf66728(ActivityResult activityResult) {
    ...
    public void m121xffa00d47(ActivityResult activityResult) {
        if (activityResult.getResultCode() != -1 || activityResult.getData() == null) {
            return;
        }
    ...
    public void m123xe2f35985(ActivityResult activityResult) {
        if (activityResult.getResultCode() != -1 || activityResult.getData() == null) {
            return;
        }
        ...
        try {
            this.disposable.add((Disposable) Observable.fromCallable(new Callable() {
                @Override
                public final Object call() {
                    return VideoActivity.this.m122xf149b366();
                }
            }).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribeWith(new DisposableObserver<Boolean>() {
                @Override
                public void onError(Throwable th) {
                ...
                public void onComplete() {
                    VideoActivity.this.binding.rlProgess.setVisibility(View.GONE);
                    VideoActivity.this.refreshList();
                    Toast.makeText(VideoActivity.this, "Copied Files Successfully", Toast.LENGTH_SHORT).show();
                }
            }));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void m124xd49cffa4(ActivityResult activityResult) {
        int indexOf;
        if (activityResult.getResultCode() != -1 || activityResult.getData() == null) {
            return;
        }
    ...
    public void m126xb7f04be2(ActivityResult activityResult) {
    ...
    public void isAllSelected(ArrayList<FileListModel> arrayList) {
        ...
        if (arrayList.size() > 0) {
            this.binding.toolBarVideo.title.setText("Select(" + arrayList.size() + ")");
        } else {
            this.binding.toolBarVideo.title.setText("Video");
        }
    }
    ...
    private void search(SearchView searchView) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String str) {
                if (VideoActivity.this.adapter != null) {
                    VideoActivity.this.adapter.getFilter().filter(str, new Filter.FilterListener() {
                        @Override
                        public void onFilterComplete(int i) {
                            if (i == 0) {
                                VideoActivity.this.binding.rvNodata.setVisibility(View.VISIBLE);
                            } else {
                                VideoActivity.this.binding.rvNodata.setVisibility(View.GONE);
                            }
                        }
                    });
                }
        ...
        searchView.setOnCloseListener(new SearchView.OnCloseListener() {
            ...
            public boolean onClose() {
                VideoActivity.this.isSearch = false;
                return false;
            }
        });
    }
