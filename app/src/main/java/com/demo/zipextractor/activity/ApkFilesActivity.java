...
import com.demo.zipextractor.databinding.ActivityApkFilesBinding;
...
public class ApkFilesActivity extends BaseActivity implements RecyclerItemClick, CheakBoxClick, View.OnClickListener {
    ...
    public void setToolBar() {
        ...
        this.binding.toolBarApk.cardBack.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void fillData() {
        ...
        new DocumentFetcher(this, FileRoot.APK, FileRoot.APK, "", DocumentFetcher.ORDER_AZ, new DocumentFetcher.OnFileFetchListnear() {
            @Override
        ...
        this.binding.toolBarApk.cardSort.setVisibility(View.VISIBLE);
    }
    ...
    public void onRecyclerClick(int i) {
        ...
        for (ResolveInfo resolveInfo : getPackageManager().queryIntentActivities(intent, 65536)) {
            grantUriPermission(resolveInfo.activityInfo.packageName, uriForFile, Intent.FLAG_GRANT_READ_URI_PERMISSION);
        }
    ...
    public void onCheakBoxClick(int i, ArrayList<FileListModel> arrayList) {
        ...
        if (arrayList.size() > 0) {
            ...
            this.binding.toolBarApk.cardCopy.setVisibility(View.VISIBLE);
            this.binding.toolBarApk.cardSort.setVisibility(View.GONE);
            this.binding.tvItem.setText(arrayList.size() + " items");
        } else {
            this.binding.llOption.setVisibility(View.GONE);
            this.binding.toolBarApk.cardCopy.setVisibility(View.GONE);
            this.binding.toolBarApk.cardSort.setVisibility(View.VISIBLE);
        }
        ...
        switch (view.getId()) {
            ...
            case R.id.buttonnCompress:
                ...
                this.disposable.add((Disposable) Observable.fromCallable(new Callable() {
                    ...
                    public final Object call() {
                        return ApkFilesActivity.this.m68x5bc854b0();
                    }
                    ...
                    public void onComplete() {
                        if (!ApkFilesActivity.this.nameFile.isEmpty()) {
                            ApkFilesActivity.this.binding.rlProgess.setVisibility(View.GONE);
                        }
                        ApkFilesActivity.this.refreshList();
                        Toast.makeText(ApkFilesActivity.this, "Zip File Successfully", Toast.LENGTH_SHORT).show();
                    }
                }));
                return;
            case R.id.cardBack:
            ...
            case R.id.layoutCopy:
                ...
                this.activityLauncher.launch(intent, new BetterActivityResult.OnActivityResult() {
                    ...
                    public final void onActivityResult(Object obj) {
                        ApkFilesActivity.this.m66x4152f1ae((ActivityResult) obj);
                    }
                });
            ...
            case R.id.layoutExtract:
                this.activityLauncher.launch(new Intent(this, SaveLocationActivity.class), new BetterActivityResult.OnActivityResult() {
                    ...
                    public final void onActivityResult(Object obj) {
                        ApkFilesActivity.this.m64x26dd8eac((ActivityResult) obj);
                    }
                });
                this.dialogMultiBottomSheet.dismiss();
                return;
            ...
            case R.id.layoutMove:
                ...
                this.activityLauncher.launch(intent2, new BetterActivityResult.OnActivityResult() {
                    ...
                    public final void onActivityResult(Object obj) {
                        ApkFilesActivity.this.m67xce8da32f((ActivityResult) obj);
                    }
                });
                this.dialogMultiBottomSheet.dismiss();
                return;
            ...
            case R.id.ll:
                ...
                this.activityLauncher.launch(intent4, new BetterActivityResult.OnActivityResult() {
                    ...
                    public final void onActivityResult(Object obj) {
                        ApkFilesActivity.this.m69xe9030631((ActivityResult) obj);
                    }
                });
                return;
            case R.id.llCompress:
                ...
                this.activityLauncher.launch(intent5, new BetterActivityResult.OnActivityResult() {
                    ...
                    public final void onActivityResult(Object obj) {
                        ApkFilesActivity.this.m65xb418402d((ActivityResult) obj);
                    }
                });
                return;
            case R.id.llDateAsc:
    ...
    public void m64x26dd8eac(ActivityResult activityResult) {
    ...
    public void m65xb418402d(ActivityResult activityResult) {
        if (activityResult.getResultCode() != -1 || activityResult.getData() == null) {
            return;
        }
    ...
    public void m66x4152f1ae(ActivityResult activityResult) {
        if (activityResult.getResultCode() != -1 || activityResult.getData() == null) {
            return;
        }
    ...
    public void m67xce8da32f(ActivityResult activityResult) {
        int indexOf;
        if (activityResult.getResultCode() != -1 || activityResult.getData() == null) {
            return;
        }
    ...
    public void m69xe9030631(ActivityResult activityResult) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String str) {
                if (ApkFilesActivity.this.adapter != null) {
                    ApkFilesActivity.this.adapter.getFilter().filter(str, new Filter.FilterListener() {
                        @Override
                        public void onFilterComplete(int i) {
                            if (i == 0) {
                                ApkFilesActivity.this.binding.rvNodata.setVisibility(View.VISIBLE);
                            } else {
                                ApkFilesActivity.this.binding.rvNodata.setVisibility(View.GONE);
                            }
                        }
                    });
                }
